...
async function runCliJson<T>(
  ...
  const proc = Bun.spawn({
    ...
    env: {
      ...process.env,
      WOOO_OKX_ONCHAIN_API_KEY_REF: "env:WOOO_TEST_OKX_ONCHAIN_API_KEY",
      WOOO_TEST_OKX_ONCHAIN_API_KEY: "test-api-key",
      WOOO_OKX_ONCHAIN_SECRET_REF: "env:WOOO_TEST_OKX_ONCHAIN_SECRET",
      WOOO_TEST_OKX_ONCHAIN_SECRET: "test-secret",
      WOOO_OKX_ONCHAIN_PASSPHRASE_REF: "env:WOOO_TEST_OKX_ONCHAIN_PASSPHRASE",
      WOOO_TEST_OKX_ONCHAIN_PASSPHRASE: "test-passphrase",
      ...env,
    },
    stdout: "pipe",
    stderr: "pipe",
